...
currentSavingsLabel.innerText = formatNumberWithSeparators(
...
currentIncomeLabel.innerText = formatNumberWithSeparators(
		...
		data: {
			datasets: [
				...
				},
				{
					...
					data: [
						{ x: me.timeToTargetWithLoan(target) / 12, y: target },
					],
